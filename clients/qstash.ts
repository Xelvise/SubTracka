...
if (env === "prod" && !QSTASH_CURRENT_SIGNING_KEY) throw new Error("QStash current signing key is missing");
if (env === "prod" && !QSTASH_NEXT_SIGNING_KEY) throw new Error("QStash next signing key is missing");
